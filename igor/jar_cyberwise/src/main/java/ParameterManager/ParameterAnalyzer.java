...
public class ParameterAnalyzer {
    public static void AnalisarDados(Monitoring components, Integer idMaquina, Machine machine, String horaInicio, String horaFim){
...
//       Disco
       if(porcentagemDisco >= alertaDisco && porcentagemDisco < criticoDisco){
        ...
        InsertData.inserirBanco(components, idMaquina, machine, horaInicio, horaFim);
    }
}
